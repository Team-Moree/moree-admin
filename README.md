...
주소 검색 기능을 사용하는 환경에는 `VITE_GOOGLE_MAPS_KEY` 를 설정합니다 (Google Cloud Console에서 Maps JavaScript API, Places API (New) 활성화 필요).
...
- `VITE_GOOGLE_MAPS_KEY` = Google Maps API 키, Maps JavaScript API + Places API (New) 활성화 필요 (Production, Preview 모두)
